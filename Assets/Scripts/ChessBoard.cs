...
public class ChessBoard : MonoBehaviour
{
    ...
    //CAMERA POSITON
    public Camera camera1; // White team camera
    public Camera camera2; // Black team camera
    public float transitionSpeed; // Speed of camera transition
